...
//void display_all(client *head, char *buffer) {
//    if (!head) {
//        sprintf(buffer, "No clients in the bank\n");
//    } else {
//        client *temp = head;
//        char tempBuffer[512]; // Temporary buffer for each client data
//        strcpy(buffer, ""); // Clear the buffer
//
//        while (temp && temp->id >= 0) {
//            sprintf(tempBuffer, "Client Data:\nName: %s\nPassword: %s\nBalance: %.2lf\nID: %d\n\n",
